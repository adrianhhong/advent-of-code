seed_ranges = [11, 312415190, 1034820096, 106131293, 682397438, 30365957, 2858337556, 1183890307, 665754577, 13162298, 2687187253, 74991378, 1782124901, 3190497, 208902075, 226221606, 4116455504, 87808390, 2403629707, 66592398]
# seed_ranges = [11, 10,12,5]

seeds = []

for i in range(0, len(seed_ranges), 2):
    for n in range(seed_ranges[i], seed_ranges[i] + seed_ranges[i+1]):
        seeds.append(n)
